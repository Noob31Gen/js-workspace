...
export function buildWorkerDependencyLoader(nodes: WorkspaceNode[], currentFilePath: string): string {
  ...
  parts.push("  var evalFunc = new Function('module', 'exports', 'require', 'workspace', 'process', 'Buffer', '__dirname', '__filename', 'dirname', 'filename', 'global',");
  ...
  parts.push('  };');
  parts.push('');
  parts.push('  var resultExports = evalFunc(moduleObj, exportsObj, scopedRequire, scopedWorkspace, processModule, BufferModule, _modDirname, _modFilename, _modDirname, _modFilename, self.global);');
