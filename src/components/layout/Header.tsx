...
import { ShieldCheck, ShieldAlert, Terminal, Code2, BookOpen, ExternalLink, Globe } from 'lucide-react';
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-muted-foreground hidden sm:block">
            Browser Script Execution, JSDoc Parameter Detection & Visual Frame Sandbox
          </p>
        </div>
      </div>
